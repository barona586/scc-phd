...
The \textbf{progress report} should be started and submitted to Moodle by the first day of the 5th month of registration, confirming the above items have taken place, and providing details where necessary. The appraisal panel will provide written feedback via Moodle, and make arrangements for the next appraisal. Note, there is no appraisal panel meeting required at this stage.
...
\section{16 months}
An updated \textbf{progress report} to be submitted via Moodle by the first day of the 17th month of registration, including a brief reflection on the confirmation panel feedback. The appraisal panel will provide written feedback via Moodle, and make arrangements for the next appraisal.
...
\section{28 months}
An updated \textbf{progress report} to be submitted via Moodle by the first day of the 29th month of registration. The appraisal panel will provide written feedback via Moodle, and make arrangements for the next appraisal.
