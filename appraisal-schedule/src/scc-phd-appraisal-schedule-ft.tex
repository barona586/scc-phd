...
The schedule of dates set out below are the default dates for a full-time PhD student. An individual's schedule may change, for example if there are periods of intercalation. You will receive reminders for each appraisal point via Moodle a month before the deadline.
...
\section{30 months}
An updated \textbf{progress report} to be submitted via Moodle by the first day of the 31st month of registration.
